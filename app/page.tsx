  ...
  return (
    <main className="home-shell">
      ...
      <section className="game-picker" aria-label="Juegos">
        ...
        <Link href="/stat-line" className="compact-game stat-line-home"><span>06</span><div className="compact-art stat-line-art"><b>27</b><i>PTS</i></div><h2>STAT LINE</h2></Link>
