  ...
  return (
    <main className="home-shell">
      ...
      <nav className="play-type-switch" aria-label="Modo de juego">
        <Link className="active" href="/" aria-current="page"><span>01</span><b>INDIVIDUAL</b><i>JUEGOS DIARIOS</i></Link>
        <Link href="/leagues"><span>02</span><b>LIGAS</b><i>COMPITE CON AMIGOS</i></Link>
      </nav>
